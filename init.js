var SubjectObj = [
    {
        ...
        wsurl_TF: "https://script.google.com/macros/s/AKfycbwIKPgNzq2ooLh9wXzFru9_Q-Ja9AUV-m70WcECgQ/exec"
    },
    {
        id: "subject2",
        name: "實務課程",
    ...
    $.getJSON(url, function (json_data) {
        ...
        $.each(json_data, function (key, val) {
            ...
            if (type === "MC") {
                ...
                tmp = new Quiz_MultipleChoice("Q" + val.index, val.data[2], val.data[3], val.data[4], val.data[5], val.data[6], val.data[1], val.data[7]);
                QuizArr.push(tmp);
                ...
                tmp = new Quiz_TrueFalse("Q" + val.index, val.data[2], val.data[3], val.data[4], val.data[1] === "1" ? "O" :"X", val.data[5]);
                QuizArr.push(tmp);
                temphtml = '<div id="' + tmp.id + '" class="ui form">\
                              <div class="grouped fields">\
                                <label>'+ tmp.id + '. ' + tmp.question + '</label>\
